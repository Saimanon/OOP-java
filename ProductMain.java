...
public class ProductMain {
    ...
    public static void main(String[] args) {
        ...
        HotDrink hotDrink1 = new HotDrink("Кофе", 100, LocalDate.of(2024, 6, 1), 85);
        HotDrink hotDrink2 = new HotDrink("Чай", 50, LocalDate.of(2024, 6, 1), 90);
        HotDrinkVM hotDrinkVM = new HotDrinkVM();
        hotDrinkVM.addProducts(List.of(hotDrink1, hotDrink2));

        System.out.println(hotDrinkVM.getProducts());

        hotDrinkVM.getProduct("Кофе", 1, 85);
